...
if ( !class_exists( 'TC_Custom_Fonts' ) ) {
	...
	class TC_Custom_Fonts {
		...
		function __construct() {
			$this->form_title				 = __( 'Custom Fonts', 'tc' );
		...
		function get_custom_fonts_fields() {
			...
			$default_fields = array(
				array(
					...
					'field_title'		 => __( 'Font Name', 'tc' ),
					'field_type'		 => 'text',
					'field_description'	 => __( 'Set the font name. ', 'tc' ),
					'table_visibility'	 => true,
					'post_field_type'	 => 'post_meta',
				),
				array(
					'field_name'		 => 'custom_font',
					'field_title'		 => __( 'File', 'tc' ),
					'field_type'		 => 'image',
					'field_description'	 => __( 'Browse for a font file.', 'tc' ),
