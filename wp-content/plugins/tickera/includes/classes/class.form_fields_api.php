			...
			<tr valign="top">
				...
				<td class="forminp">
					<fieldset>
						...
						<input class="input-text regular-input <?php echo esc_attr( $data[ 'class' ] ); ?>" type="<?php echo esc_attr( $data[ 'type' ] ); ?>" name="<?php echo esc_attr( $field ); ?>" id="<?php echo esc_attr( $field ); ?>" style="<?php echo esc_attr( $data[ 'css' ] ); ?>" value="<?php echo esc_attr( wp_unslash( $this->get_option( $key, $data ) ) ); ?>" placeholder="<?php echo esc_attr( $data[ 'placeholder' ] ); ?>" <?php disabled( $data[ 'disabled' ], true ); ?> <?php echo $this->get_custom_attribute_field( $data ); ?> />
				...
				<td class="forminp">
					<fieldset>
						...
						<?php foreach ( $data[ 'options' ] as $option => $value ) { ?>
							...
							<label class="tc_checkboxes_label" for="<?php echo $value; ?>">
								<input type="checkbox" name="<?php echo $field; ?>[]" id="<?php echo esc_attr($value); ?>"  value="<?php echo esc_attr( $option ); ?>" <?php
