						...
						<tbody>
							...
							foreach ( $cart_contents as $ticket_type => $ordered_count ) {
								...
								<tr>
									...
									<td class="ticket-quantity" class="ticket_quantity"><input class="tickera_button minus" type="button" value="-"><input type="text" name="ticket_quantity[]" value="<?php echo (int) $ordered_count; ?>" class="quantity">  <input class="tickera_button plus" type="button" value="+" /></td>
