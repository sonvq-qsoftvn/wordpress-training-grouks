	...
	<div class="tc-wiz-screen-wrap tc-license-key <?php echo tc_wizard_wrapper_class(); ?>">
		...
		<div class="tc-wiz-screen">
			...
			<div class="tc-wiz-screen-content">
				...
				<p>
					<?php printf( __( 'You can obtain your license key %1$shere%2$s. You\'ll need it in order to receive automatic updates for the plugin. A valid license key is also required if you want to use %3$sChrome Desktop check-in application%2$s.', 'tc' ), '<a href="https://tickera.com/downloads/" target="_blank">', '</a>', '<a href="https://tickera.com/chrome-desktop-checkin-app/" target = "_blank">' ); ?>
				</p>
				<?php
