							...
							foreach ( $input_4 as $key_4 => $val_4 ) {
								if ( is_array( $val_4 ) ) {
									...
									foreach ( $input_5 as $key_5 => $val_5 ) {
										$new_input[ $key ][ $key_2 ][ $key_3 ][ $key_4 ][ $key_5 ] = sanitize_text_field( $val_5 );
									}
								} else {
									$new_input[ $key ][ $key_2 ][ $key_3 ][ $key_4 ] = sanitize_text_field( $val_4 );
								}
							}
						} else {
							$new_input[ $key ][ $key_2 ][ $key_3 ] = sanitize_text_field( $val_3 );
						}
					}
				} else {
					$new_input[ $key ][ $key_2 ] = sanitize_text_field( $val_2 );
				}
			}
		} else {
