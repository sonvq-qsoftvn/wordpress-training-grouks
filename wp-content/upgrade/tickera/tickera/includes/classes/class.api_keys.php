		...
		function get_api_keys_fields() {
			...
			$default_fields = array(
				...
				array(
					...
					'field_type'		 => 'text',
					'field_description'	 => sprintf( __( 'This is the API Key you will have to enter in your %3$s %1$s, %2$s or premium %4$s check-in application', 'tc' ), '<a href="https://itunes.apple.com/us/app/ticket-checkin/id958838933" target="_blank">' . __( 'iPhone', 'tc' ) . '</a>', '<a href="https://play.google.com/store/apps/details?id=com.tickera.tickeraapp" target="_blank">' . __( 'Android', 'tc' ) . '</a>', $tc->title, '<a href="https://chrome.google.com/webstore/detail/check-in/iblommpedaboemnefjildfmpjpmjapnp" target="_blank">Chrome Desktop</a>' ),
					'table_visibility'	 => true,
					'post_field_type'	 => 'post_meta',
				...
				array(
					'field_name'		 => 'api_url',
					'field_title'		 => __( 'API / WordPress URL', 'tc' ),
					'field_type'		 => 'function',
					'function'			 => 'tc_api_get_site_url',
					'field_description'	 => __( 'This is the exact URL you should put in the check-in app.', 'tc' ),
