	...
	class TC_Tickets {
		...
		public static function get_ticket_fields() {
			...
			$default_fields[] = array(
				...
				'tooltip'			 => 'Choose if you want to limit ticket sales availability for certain date range or leave it as open-ended.',
				'table_visibility'	 => false,
				'post_field_type'	 => 'post_meta',
			);
			...
			$default_fields[] = array(
				...
				'field_title'		 => __( 'Available dates for check-in', 'tc' ),
				'field_type'		 => 'function',
				'function'			 => 'tc_get_ticket_checkin_availability_dates',
				'tooltip'			 => 'Choose if you want to limit ticket check-ins for certain date range or leave it as open-ended.',
				'table_visibility'	 => false,
				'post_field_type'	 => 'post_meta',
			);
