	...
	class TC_Ticket_Template_Elements {
		...
		function get_document_sizes() {
			...
			<select name="document_ticket_size_post_meta">
				<option value="A4" <?php selected( isset( $this->template_metas[ 'document_ticket_size' ] ) ? $this->template_metas[ 'document_ticket_size' ] : 'A4', 'A4', true ); ?>><?php echo _e( 'A4 (210 × 297)', 'tc' ); ?></option>
				<option value="A5" <?php selected( isset( $this->template_metas[ 'document_ticket_size' ] ) ? $this->template_metas[ 'document_ticket_size' ] : 'A4', 'A5', true ); ?>><?php echo _e( 'A5 (148 × 210)', 'tc' ); ?></option>
		...
		function get_document_orientation() {
			...
			<select name="document_ticket_orientation_post_meta">
